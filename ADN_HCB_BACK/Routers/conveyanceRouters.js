...
import { addConveyance, deleteConveyanceBill, getConveyance, getPendingList, getSingleConveyanceBill, groupCollection, rejectConvenceBill, summaryView, updateMultipleId, updateSingleConveyance } from '../Controller/conveyanceController.js';
...
conveyanceRouter.post('/summaryView', summaryView);
